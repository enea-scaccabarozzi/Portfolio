...
export const RainbowAccentButton = ({ href, label }: IProps) => {
	return (
		<Link
			href={href}
		...
		>
			...
			<div className='bg-zinc-950 relative z-10 flex items-center space-x-2 rounded-full py-0.5 px-4 ring-1 ring-white/10 '>
				<span>{label}</span>
				<svg
					fill='none'
					height='16'
